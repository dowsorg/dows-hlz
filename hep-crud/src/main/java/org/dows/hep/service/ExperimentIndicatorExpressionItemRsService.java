...
/**
 * 实验指标公式细项(ExperimentIndicatorExpressionItem)表服务接口
 *
 * @author lait
 * @since 2023-04-21 10:31:43
 */
public interface ExperimentIndicatorExpressionItemRsService extends MybatisCrudService<ExperimentIndicatorExpressionItemRsEntity> {
