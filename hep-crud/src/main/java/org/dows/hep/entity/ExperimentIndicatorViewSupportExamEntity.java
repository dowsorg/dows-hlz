...
@Schema(name = "ExperimentIndicatorViewSupportExam", title = "实验查看指标辅助检查")
@TableName("experiment_indicator_view_support_exam")
public class ExperimentIndicatorViewSupportExamEntity implements CrudEntity {
