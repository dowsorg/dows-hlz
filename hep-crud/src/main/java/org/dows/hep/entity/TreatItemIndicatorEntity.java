...
@Schema(name = "TreatItemIndicator", title = "治疗项目关联指标")
@TableName("treat_item_indicator")
public class TreatItemIndicatorEntity implements CrudEntity {
