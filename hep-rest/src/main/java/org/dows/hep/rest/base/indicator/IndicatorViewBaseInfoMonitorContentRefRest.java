...
public class IndicatorViewBaseInfoMonitorContentRefRest {
  ...
  @Operation(summary = "批量删除查看指标基本信息指标监测内容关联指标")
  @DeleteMapping("v1/baseIndicator/indicatorViewBaseInfoMonitorContentRef/batchDelete")
  public void batchDelete(@RequestBody List<String> indicatorViewBaseInfoMonitorContentRefIdList) throws InterruptedException {
    indicatorViewBaseInfoMonitorContentRefBiz.batchDelete(indicatorViewBaseInfoMonitorContentRefIdList);
  }
