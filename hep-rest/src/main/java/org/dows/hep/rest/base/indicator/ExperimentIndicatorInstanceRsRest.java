...
public class ExperimentIndicatorInstanceRsRest {
  ...
  @PostMapping("v1/experimentIndicator/core/get")
  public Map<String, List<String>> getCoreByPeriodsAndExperimentPersonIdList(@RequestBody RsExperimentGetCoreRequest rsExperimentGetCoreRequest) {
    if (Objects.isNull(rsExperimentGetCoreRequest)) {return new HashMap<>();}
    Integer periods = rsExperimentGetCoreRequest.getPeriods();
    List<String> experimentPersonIdList = rsExperimentGetCoreRequest.getExperimentPersonIdList();
    return experimentIndicatorInstanceRsBiz.getCoreByPeriodsAndExperimentPersonIdList(periods, experimentPersonIdList);
  }
}