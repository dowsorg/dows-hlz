...
docker_images=("$docker_registry/findsoft/api-hep-admin-dev" "$docker_registry/findsoft/h5-hep-admin-dev" "$docker_registry/findsoft/h5-hep-user-dev")
docker_network="dev_net"
...
start_or_restart_container() {
    ...
    if check_container_running "$container_name"-dev; then
