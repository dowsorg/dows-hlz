...
public enum EnumIndicatorCategory {
  ...
  VIEW_MANAGEMENT_NO_REPORT_TWO_LEVEL("10303", "二级类-无报告，即所属类型只有一级，1+1"),
  VIEW_MANAGEMENT_NO_REPORT_FOUR_LEVEL("10304", "四级类-无报告，即所属类型只有三级，1+3"),
  OPERATE_MANAGEMENT("104", "操作指标"),
  OPERATE_MANAGEMENT_INTERVENE_DIET("10401", "饮食干预"),
  OPERATE_MANAGEMENT_INTERVENE_SPORTS("10402", "运动干预"),
