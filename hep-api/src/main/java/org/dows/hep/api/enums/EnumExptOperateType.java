...
public enum EnumExptOperateType {
    ...
    VIEWFollowUp(2,EnumIndicatorCategory.VIEW_MANAGEMENT_MONITOR_FOLLOWUP,"监测随访",-1,true,0,false),
    ...
    INTERVENEFood(11,EnumIndicatorCategory.OPERATE_MANAGEMENT_INTERVENE_DIET,"饮食干预",-1,false,0,false),
