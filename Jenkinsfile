            ...
            steps {
                script {
                    ...
                    if (branch.startsWith('dev-')) {
                        ...
                        sh "sshpass -p $AS_PWD ssh $AS_USERNAME@$AS_HOST $TO_SIT_CD_PATH/admin/robot.sh '$branch' '$gitCommitAuthorName' 'api-hep-admin' 'SIT环境发布' '$gitCommitMessage' '$changes' 'green'"
