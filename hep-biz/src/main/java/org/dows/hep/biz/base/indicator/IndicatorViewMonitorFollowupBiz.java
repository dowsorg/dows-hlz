...
public class IndicatorViewMonitorFollowupBiz {
    ...
    public void createOrUpdateRs(CreateOrUpdateIndicatorViewMonitorFollowupRequestRs createOrUpdateIndicatorViewMonitorFollowupRequestRs) throws InterruptedException {
        ...
        List<CreateOrUpdateIndicatorViewMonitorFollowupFollowupContentRequestRs> createOrUpdateIndicatorViewMonitorFollowupFollowupContentRequestRsList
                = createOrUpdateIndicatorViewMonitorFollowupRequestRs.getCreateOrUpdateIndicatorViewMonitorFollowupFollowupContentRequestRsList();
        if (!createOrUpdateIndicatorViewMonitorFollowupFollowupContentRequestRsList.isEmpty()) {
            ...
            if (!paramIndicatorViewMonitorFollowupFollowupContentIdSet.isEmpty()) {
                ...
                if (paramIndicatorViewMonitorFollowupFollowupContentIdSet.stream()
                        .anyMatch(indicatorViewMonitorFollowupFollowupContentId -> !dbIndicatorViewMonitorFollowupFollowupContentIdSet
                                .contains(indicatorViewMonitorFollowupFollowupContentId))) {
            ...
            if (!paramIndicatorViewMonitorFollowupContentRefIdSet.isEmpty()) {
                ...
                if (paramIndicatorViewMonitorFollowupContentRefIdSet.stream()
                        .anyMatch(indicatorViewMonitorFollowupContentRefId -> !dbIndicatorViewMonitorFollowupContentRefIdSet
                                .contains(indicatorViewMonitorFollowupContentRefId))) {
            ...
            if (!paramIndicatorInstanceIdSet.isEmpty()) {
                ...
                if (paramIndicatorInstanceIdSet.stream().anyMatch(indicatorInstanceId -> !dbIndicatorInstanceIdSet.contains(indicatorInstanceId))) {
