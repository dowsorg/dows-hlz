...
public class ExperimentTimerBiz {
    ...
    private final ExperimentFlowRules experimentFlowRules;
    ...
    public List<ExperimentTimerEntity> getPeriodsTimerList(String experimentInstanceId) {
        return Optional.ofNullable( ExperimentTimerCache.Instance().getCacheData(experimentInstanceId))
                .map(ExperimentTimerCache.CacheData::getTimerList)
    ...
    public Map<Integer, ExperimentTimerEntity> getExperimentPeriodsStartAnsEndTime(String experimentInstanceId) {
        return Optional.ofNullable( ExperimentTimerCache.Instance().getCacheData(experimentInstanceId))
                .map(ExperimentTimerCache.CacheData::getMapTimer)
