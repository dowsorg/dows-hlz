...
@Component
public class CalcHealthIndexBiz {
    ...
    public void calcPersonHelthIndex(ExperimentRsCalculateAndCreateReportHealthScoreRequestRs req)  {
        ...
        kExperimentPersonIdVHealthExperimentIndicatorValRsEntityMap.forEach((experimentPersonId, healthExperimentIndicatorValRsEntity) -> {
            ...
            BigDecimal personHealthIndex= CalcHealthIndexUtil.calcPersonHealthIndex(vosHealthIndex,false);
